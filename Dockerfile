...
RUN curl https://down.115.com/client/115pc/lin/115Life_${APP_VERSION}.deb -o /tmp/115Life_${APP_VERSION}.deb
RUN dpkg -i /tmp/115Life_${APP_VERSION}.deb
